...
<div id="tos-content-wrap">
	<div class="tos-content">
		<h1 class="tos-content-header"><i class="fa-solid fa-spinner"></i> 이용약관</h1>
		<hr />
		<div class="tos-content-list">
			<h3 class="list-header">제1조 목적</h3>
			<div class="list-content">
				<ol>
					<li>
						이 약관은 ㈜샐러브리티(전자상거래 사업자)가 운영하는 샐러브리티 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
						<br /><br />
						※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
					</li>
				</ol>
			</div>
			<h3 class="list-header">제2조 정의</h3>
			<div class="list-content">
				<ol>
					<li>“몰”이란 ㈜샐러브리티가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</li>
			...
			<h3 class="list-header">제3조 약관 등의 명시와 설명 및 개정</h3>
			<div class="list-content">
				<ol>
					<li>“몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 샐러브리티 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</li>
			...
			<h3 class="list-header">제4조 서비스의 제공 및 변경</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제5조 서비스의 중단</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제6조 회원가입</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제7조 회원 탈퇴 및 자격 상실 등</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제8조 회원에 대한 통지</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제9조 구매신청 및 개인정보 제공 동의 등</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제10조 계약의 성립</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제11조 지급방법</h3>
			<div class="list-content">
				<ol>
					<li>“몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도  추가하여 징수할 수 없습니다.
						<ol>
			...
			<h3 class="list-header">제12조 수신확인통지.구매신청 변경 및 취소</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제13조 재화 등의 공급</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제14조 환급</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제15조 청약철회 등</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제16조 청약철회 등의 효과</h3>
			<div class="list-content">
				<ol>
					<li>“몰”은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 “몰”이 이용자에게 재화등의 환급을 지연한때에는 그 지연기간에 대하여 「전자상거래 등에서의 소비자보호에 관한 법률 시행령」제21조의2에서 정하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.</li>
			...
			<h3 class="list-header">제17조 개인정보보호</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제18조 “몰”의 의무</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제19조 회원의 ID 및 비밀번호에 대한 의무</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제20조 이용자의 의무</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제21조 연결 “몰”과 “몰” 간의 관계</h3>
			<div class="list-content">
				<ol>
					<li>상위 “몰”과 하위 “몰”이 하이퍼링크(예: 하이퍼링크의 대상에는 문자, 그림 및 동화상 등이 포함됨)방식 등으로 연결된 경우, 전자를 연결 “몰”(웹 사이트)이라고 하고 후자를 피연결 “몰”(웹사이트)이라고 합니다.</li>
			...
			<h3 class="list-header">제22조 저작권의 귀속 및 이용제한</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제23조 분쟁해결</h3>
			<div class="list-content">
				<ol>
			...
			<h3 class="list-header">제24조 재판권 및 준거법</h3>
			<div class="list-content">
				<ol>
 ...
 * 리스트 아코디언 처리
 */
$('.tos-content-list .list-header').click(function (e) {
	e.preventDefault();
