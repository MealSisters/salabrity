...
<div class="item">
    ...
    <a href=""><img src="<%= request.getContextPath() %>/images/food_sample.jpg" alt="" class="item_img"></a>
    <div class="item_tit">당뇨케어식단</div>
    <div class="item_dsc">1일 2식 2주(월~금, 20회)</div>

    <div class="item_price">100,000원</div>
    <a href="" class="add_cart"><i class="fa-solid fa-cart-plus"></i></a>
</div>
