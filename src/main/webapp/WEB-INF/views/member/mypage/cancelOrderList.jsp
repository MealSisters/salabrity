...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/member/cancelOrderList.css" />
	<%@ include file="/WEB-INF/views/common/myPageSidebar.jsp"%>
<section id="cancel_list">
...
<script>
const question_btns = document.querySelectorAll('#cancel_list tr.row2 td.col4');
console.log(question_btns);
question_btns.forEach(function (elem) {
    elem.addEventListener('click', function () {
        location.href = '/salabrity/mypage/boardQuestion';
    });
});

const order_infoes = document.querySelectorAll('#cancel_list tr .col1, #cancel_list tr .col2,#cancel_list tr .col3');
console.log(order_infoes);

order_infoes.forEach(function (elem) {
    elem.addEventListener('click', function () {
        location.href = '/salabrity/mypage/orderView';
    });
});
const cart_btns = document.querySelectorAll('#cancel_list tr.row1 td.col4');
console.log(cart_btns);
cart_btns.forEach(function (elem) {
    elem.addEventListener('click', function () {
        location.href = '/salabrity/order/cart';
    });
});
</script>
