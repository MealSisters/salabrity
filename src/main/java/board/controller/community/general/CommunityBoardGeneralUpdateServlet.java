...
public class CommunityBoardGeneralUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/views/board/community/general/communityBoardGeneralUpdate.jsp")
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			response.sendRedirect(request.getContextPath() + "/board/community/generalView?no=" + no);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		}
