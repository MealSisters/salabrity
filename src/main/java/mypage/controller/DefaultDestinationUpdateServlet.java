...
/**
 * Servlet implementation class DefaultDestinationUpdate
 */
@WebServlet("/mypage/destination/defaultUpdate")
public class DefaultDestinationUpdateServlet extends HttpServlet {
